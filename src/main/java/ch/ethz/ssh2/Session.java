...
public class Session
{
	...
	boolean closeAftWait = false;
	boolean closeInProcesser = true; // default
	private final SecureRandom rnd;

	public Session(){
		this.rnd = null;
		this.name = "SESSID-"+Calendar.getInstance().getTime().getTime() + new Random().nextInt(10);
	}
	...
	public boolean isCloseAftWait() {
		return closeAftWait;
	}

	public void setCloseAftWait(boolean closeAftWait) {
		this.closeAftWait = closeAftWait;
	}

	public boolean isCloseInProcesser() {
		return closeInProcesser;
	}

	public void setCloseInProcesser(boolean closeInProcesser) {
		this.closeInProcesser = closeInProcesser;
	}
}
